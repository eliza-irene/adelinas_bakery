...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "Adelina's Bakery"
  ...
  # config.dragonfly_secret = "a3291967c2e99f4b19929ae231ede58e9ff66d902f948263"

  # Add extra tags to the wymeditor whitelist e.g. = {'tag' => {'attributes' => {'1' => 'href'}}} or just {'tag' => {}}
  # config.wymeditor_whitelist_tags = {}

  # Register extra javascript for backend
  config.register_javascript "lightbox"
  config.register_javascript "gallery"

  # Register extra stylesheet for backend (optional options)
  config.register_stylesheet "custom", :media => 'screen'
  config.register_stylesheet "grid", :media => 'screen'
  config.register_stylesheet "responsive", :media => 'screen'
  config.register_stylesheet "lightbox", :media => 'screen'
